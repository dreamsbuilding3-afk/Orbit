    ...
    <main className="ark-opportunities-page">
      <header className="ark-opportunities-top">
        ...
        <nav>
          ...
          <Link className="active" href="/ark/opportunities">Opportunities</Link>
      ...
      <style jsx global>{`
        ...
        .ark-opportunities-top nav{display:flex;gap:20px}.ark-opportunities-top nav a{font-size:10px;color:#999;text-decoration:none;white-space:nowrap}.ark-opportunities-top nav a:hover,.ark-opportunities-top nav .active{color:#111}.ark-opportunities-top nav .active{font-weight:600}
        ...
        @media(max-width:1050px){.ark-opportunities-top nav{gap:14px}.ark-opportunities-top nav a{font-size:9px}}
