...
export default function WorkflowsPage() {
  ...
  return <main className="app-shell"><section className="content" style={{width:"100%"}}>
    ...
    <div className="page workflows-page">
      ...
      <div className="section-heading"><div><p className="eyebrow">YOUR AUTOMATIONS</p><h2>{loading?"Loading workflows…":`${workflows.length} workflow${workflows.length===1?"":"s"}`}</h2></div><span className="workflow-hint">Your workflows stay isolated to the organizations you belong to.</span></div>
