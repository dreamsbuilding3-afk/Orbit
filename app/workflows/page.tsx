...
export default function WorkflowsPage() {
  ...
  async function load() {
    ...
    if (!user) { setMessage("Connecte-toi à ORBIT pour voir tes workflows."); setLoading(false); return; }
  ...
  return <main className="app-shell">
    <section className="content" style={{ width: "100%" }}>
      ...
      <div className="page">
        <div className="hero-row"><div><p className="eyebrow">AUTOMATION</p><h1>Workflows that run the business.</h1><p className="hero-copy">Every workflow connects an event to the actions ORBIT should execute automatically.</p></div><Link className="primary-button" href="/workflows/new">Create workflow →</Link></div>
