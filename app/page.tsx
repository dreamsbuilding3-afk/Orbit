      ...
      <section className="content">
        ...
        <div className="page">
          <div className="hero-row">
            <div><p className="eyebrow">VOTRE ENTREPRISE, ENFIN PILOTÉE SIMPLEMENT</p><h1>WineTime comprend<br/>ce qui se passe et agit.</h1><p className="hero-copy">Connectez vos outils. WineTime détecte les événements importants, vous propose les bonnes actions et exécute le travail à votre place.</p></div>
