...
export default function Home() {
  return (
    <main className="app-shell">
      ...
      <style jsx>{`.hero-actions{display:flex;flex-direction:column;align-items:flex-start;gap:10px}.secondary-hero-button{display:inline-flex;align-items:center;gap:8px;padding:9px 12px;border-radius:10px;color:#555;text-decoration:none;font-size:12px}.hero-copy-block{position:relative;z-index:2}.hero-visual{position:relative;width:min(100%,390px);height:270px;justify-self:center;display:grid;place-items:center;isolation:isolate;overflow:visible}.hero-glow{position:absolute;width:210px;height:210px;border-radius:50%;background:radial-gradient(circle,rgba(255,255,255,.98) 0%,rgba(236,236,234,.55) 38%,rgba(255,255,255,0) 72%);filter:blur(4px);animation:heroBreath 7s ease-in-out infinite}.hero-orbit{position:absolute;width:255px;height:112px;border:1px solid rgba(80,80,78,.13);border-radius:50%;box-shadow:inset 0 0 20px rgba(255,255,255,.9),0 12px 35px rgba(0,0,0,.025);transform-style:preserve-3d}.hero-orbit-a{transform:rotateX(68deg) rotateZ(12deg);animation:heroOrbitA 12s linear infinite}.hero-orbit-b{width:220px;height:96px;transform:rotateX(68deg) rotateY(58deg) rotateZ(-20deg);animation:heroOrbitB 15s linear infinite reverse}.hero-orbit-c{width:185px;height:82px;border-color:rgba(80,80,78,.1);transform:rotateX(68deg) rotateY(-55deg) rotateZ(28deg);animation:heroOrbitC 10s linear infinite}.hero-core{position:relative;width:104px;height:104px;border-radius:30px;display:grid;place-items:center;background:linear-gradient(145deg,rgba(255,255,255,.98),rgba(226,226,224,.76));border:1px solid rgba(0,0,0,.11);box-shadow:inset 0 1px 0 #fff,0 18px 45px rgba(0,0,0,.09),0 0 0 14px rgba(255,255,255,.5);transform-style:preserve-3d;animation:heroCore 6s ease-in-out infinite}.hero-core:before{content:"";position:absolute;inset:10px;border-radius:23px;border:1px solid rgba(255,255,255,.9);box-shadow:inset 0 -10px 20px rgba(0,0,0,.035)}.hero-core span{position:relative;font-size:42px;font-weight:600;letter-spacing:-.12em;color:#20201f;text-shadow:0 1px 0 #fff}.hero-sphere{position:absolute;width:13px;height:13px;border-radius:50%;background:radial-gradient(circle at 32% 28%,#fff 0 16%,#d9d9d7 52%,#a8a8a5 100%);box-shadow:0 7px 14px rgba(0,0,0,.12),inset 1px 1px 2px #fff}.hero-sphere-a{animation:sphereA 12s linear infinite}.hero-sphere-b{animation:sphereB 15s linear infinite reverse}.hero-sphere-c{animation:sphereC 10s linear infinite}.start-card{margin:8px 0 14px;padding:24px;border:1px solid var(--line);border-radius:18px;background:linear-gradient(135deg,#fff,#f7f7f5);box-shadow:var(--shadow)}.start-intro h2{margin:4px 0 7px;font-size:24px;letter-spacing:-.04em}.start-intro>p:not(.eyebrow){margin:0;color:#7f7f7d;font-size:12px;line-height:1.6;max-width:720px}.start-steps{display:grid;grid-template-columns:repeat(3,1fr);gap:10px;margin-top:20px}.start-step{display:flex;align-items:flex-start;gap:12px;min-height:145px;padding:16px;border:1px solid var(--line);border-radius:14px;background:#fff;color:inherit;text-decoration:none;transition:transform .2s,box-shadow .2s}.start-step:hover{transform:translateY(-2px);box-shadow:0 10px 24px rgba(0,0,0,.06)}.step-number{font-size:10px;font-weight:700;letter-spacing:.08em;color:#8c8c89}.start-step div{flex:1}.start-step strong{display:block;font-size:13px;line-height:1.35}.start-step p{margin:7px 0 0;color:#898987;font-size:11px;line-height:1.55}.start-step>svg{flex:none;margin-top:2px;color:#999}.intel-strip{display:flex;justify-content:space-between;align-items:center;gap:24px;margin-bottom:14px;padding:22px;border:1px solid var(--line);border-radius:17px;background:linear-gradient(120deg,rgba(255,255,255,.95),rgba(247,247,246,.74));box-shadow:var(--shadow)}.intel-strip h2{margin:0;font-size:20px;letter-spacing:-.04em;max-width:760px}.intel-strip p:not(.eyebrow){margin:6px 0 0;color:#8b8b89;font-size:11px;line-height:1.55;max-width:760px}.intel-strip .outline-button{margin-left:auto;text-decoration:none;color:#333;white-space:nowrap}.circle-button{text-decoration:none}.value-banner{text-decoration:none;color:inherit}.ask-card{text-decoration:none;color:#fff}@keyframes heroBreath{0%,100%{transform:scale(.92);opacity:.65}50%{transform:scale(1.06);opacity:1}}@keyframes heroCore{0%,100%{transform:translateY(3px) rotateX(0deg) rotateY(-5deg)}50%{transform:translateY(-5px) rotateX(4deg) rotateY(7deg)}}@keyframes heroOrbitA{from{transform:rotateX(68deg) rotateZ(12deg)}to{transform:rotateX(68deg) rotateZ(372deg)}}@keyframes heroOrbitB{from{transform:rotateX(68deg) rotateY(58deg) rotateZ(-20deg)}to{transform:rotateX(68deg) rotateY(58deg) rotateZ(-380deg)}}@keyframes heroOrbitC{from{transform:rotateX(68deg) rotateY(-55deg) rotateZ(28deg)}to{transform:rotateX(68deg) rotateY(-55deg) rotateZ(388deg)}}@keyframes sphereA{0%{transform:translate(0,-126px)}25%{transform:translate(132px,0)}50%{transform:translate(0,126px)}75%{transform:translate(-132px,0)}100%{transform:translate(0,-126px)}}@keyframes sphereB{0%{transform:translate(112px,-45px)}25%{transform:translate(45px,90px)}50%{transform:translate(-112px,45px)}75%{transform:translate(-45px,-90px)}100%{transform:translate(112px,-45px)}}@keyframes sphereC{0%{transform:translate(-92px,-20px)}33%{transform:translate(55px,-62px)}66%{transform:translate(80px,65px)}100%{transform:translate(-92px,-20px)}}@media(max-width:1180px){.hero-row{grid-template-columns:minmax(0,1fr) minmax(260px,.8fr)}.hero-actions{grid-column:1/-1;flex-direction:row;align-items:center;margin-top:-6px}.hero-visual{grid-column:2;grid-row:1 / span 2}}@media(max-width:1100px){.start-steps{grid-template-columns:1fr}.start-step{min-height:0}.hero-actions{margin-top:20px}.intel-strip{display:block}.intel-strip .outline-button{display:inline-flex;margin-top:15px;margin-left:0;white-space:normal}}@media(max-width:900px){.hero-row{display:block}.hero-copy-block{max-width:720px}.hero-visual{width:100%;height:235px;margin:12px 0 -4px}.hero-actions{display:flex;flex-direction:column;align-items:flex-start;margin-top:0}.hero-row .primary-button{margin-top:0;display:inline-flex}.start-card{padding:18px}.start-intro h2{font-size:21px}.start-step{padding:15px}.start-step strong{font-size:14px}.start-step p{font-size:12px}.intel-strip{padding:18px}.intel-strip h2{font-size:19px}}@media(prefers-reduced-motion:reduce){.hero-glow,.hero-orbit,.hero-core,.hero-sphere{animation:none}.hero-core{transform:none}}`}</style>
    </main>
  );
}