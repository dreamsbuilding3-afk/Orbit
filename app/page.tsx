    ...
    <main className="app-shell">
      <aside className="sidebar">
        ...
        <nav className="nav">
          ...
          <p className="nav-label second">EXECUTION</p>
        ...
        <div className="sidebar-bottom"><div className="status-card"><span className="status-dot"/><div><strong>ARK + WineTime operational</strong><small>Intelligence and execution online</small></div></div><div className="profile"><span className="profile-avatar">DB</span><div><strong>Dreams Building</strong><small>Pro workspace</small></div><span className="more">•••</span></div></div>
      </aside>

      <section className="content">
        <header className="topbar"><div className="breadcrumbs"><span>WineTime</span><b>/</b><strong>Command Center</strong></div><div className="top-actions"><span className="top-avatar">DB</span></div></header>
        <div className="page">
          <div className="hero-row">
            <div><p className="eyebrow">WineTime · AUTONOMOUS BUSINESS OS</p><h1>Your business,<br/>understood and moving.</h1><p className="hero-copy">ARK thinks. WineTime executes. One intelligent system for the work between your tools.</p></div>
          ...
          <div className="metrics">
            <div className="metric-card"><span>Automations active</span><strong>12</strong><small>WineTime workflows</small></div>
          ...
          <div className="section-heading"><div><p className="eyebrow">SYSTEM ACTIVITY</p><h2>What WineTime is doing</h2></div><Link className="text-button" href="/activity">View all <Icon name="arrow" size={15}/></Link></div>
