  ...
  return (
    <main style={{ minHeight: "100vh", background: "#f8f8f8", color: "#111", fontFamily: "Arial, sans-serif", padding: "48px" }}>
      <div style={{ maxWidth: 1000, margin: "0 auto" }}>
        ...
        <div style={{ marginTop: 48, marginBottom: 32 }}><p style={{ letterSpacing: ".14em", fontSize: 11, color: "#777" }}>TRANSPARENCY</p><h1 style={{ fontSize: 42, margin: "8px 0" }}>Activity</h1><p style={{ color: "#666", fontSize: 16 }}>A clear record of every action ORBIT takes.</p></div>
